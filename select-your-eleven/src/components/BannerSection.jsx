...
const BannerSection = () => {
    return (
        <div>
            <div className='bg-[#131313] w-11/12 mx-auto p-[40px] mb-8 items-center border-gray-200 rounded-3xl text-white flex justify-center flex-col gap-4' style={{ backgroundImage: `url(${bannerShadow})` }}>
